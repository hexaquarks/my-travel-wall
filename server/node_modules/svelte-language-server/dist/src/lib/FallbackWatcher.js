...
class FallbackWatcher {
    constructor(recursivePatterns, workspacePaths) {
        this.callbacks = [];
        ...
        this.watcher = (0, chokidar_1.watch)(workspacePaths.map((workspacePath) => (0, path_1.join)(workspacePath, recursivePatterns)), {
