...
async function createLanguageService(tsconfigPath, workspacePath, docContext) {
    ...
    function getSvelteShimFiles() {
        ...
        const result = new fileCollection_1.FileSet(tsSystem.useCaseSensitiveFileNames);
        svelteTsxFiles.forEach((f) => result.add((0, utils_1.normalizePath)(f)));
        return result;
    }
    function isShimFiles(filePath) {
        return svelteTsxFiles.has((0, utils_1.normalizePath)(filePath));
    }
}
/**
